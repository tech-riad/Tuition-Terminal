...
<main class="container-custom">
    ...
    <div class="col-md-12 ms-sm-auto col-lg-12" style="margin-top: 62px">
        ...
        <div class="card-header">
            <a href="" class="btn btn-info btn-sm" data-toggle="modal" data-target="#parentImport" > <i class="fas fa-plus-circle"></i> Import Parents</a>
        </div>

        @endif

        <div class="modal fade" id="parentImport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <form id="btnalert{{ $parentt->id }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input required type="text" class="form-control"
                                                                    id="changed_note_{{$parentt->id}}" name="changed_note"
                                                                    placeholder="Enter your note here...">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer text-center">
