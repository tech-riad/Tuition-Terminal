                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body pt-4 pb-4 px-5">
                                                    ...
                                                    <div class="row row-cols-2 border-bottom border-2 mb-4">
                                                        ...
                                                        <p class="">{{$item->owner->name ?? $item->render->name ?? ''}}</p>
                                                    </div>
                                                    <div class="row row-cols-2">
...
<div class="modal fade font-pop" id="addPaymentModal" tabindex="-1" aria-labelledby="addPaymentModalLabel"
    ...
    <div class="modal-dialog modal-dialog-slide-right" style="max-width: 1100px">
        <div class="modal-content pb-4 pt-3">
            <div class="modal-header" style="padding-left: 40px; padding-right: 40px">
                <h4 class="modal-title" id="exampleModalLabel">Revenue Add</h4>
                ...
                <div class="modal-body py-0" style="padding-left: 40px">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 pe-4">
                                <div class="pb-3">
                                    <label for="trx_id" class="form-label">Transction Id</label>
                                    <div>
                                        <input type="text" class="form-control shadow rounded-2" name="trx_id"/>
                                    </div>
                                </div>
                                <div class="pb-3">
                                    <label for="datet" class="form-label required">Tutor Id</label>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 pe-4">
                                <div class="pb-3">
                                    <label for="datet" class="form-label required">Service Id</label>
                                    <input type="number" class="form-control shadow rounded-2" required name="job_offer_id"/>

                                </div>
                                <div class="pb-3">
                                    <label for="datet" class="form-label required">Application Id</label>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 pe-4">
                                <div class="pb-3">
                                    <label for="datet" class="form-label required">Amount</label>
                                    <input type="number" class="form-control shadow rounded-2" required name="received_amount"/>

                                </div>
                                <div class="pb-3">
                                    <label for="am" class="form-label text-dark required">Ownership By</label>
                        ...
                        {{-- <div class="d-flex align-items-center">
                            <div class="flex-grow-1 pe-4">
                                ...
                                <div class="pb-3">
                                    ...
                                    <select name="user" class="form-select rounded-3 shadow-none select2"
                                        aria-label="Default select" onchange="inputChange('verified_by',this.id)" id="user">
                                        <option value="">Select Employee</option>
                                        @foreach($admin as $adm)
